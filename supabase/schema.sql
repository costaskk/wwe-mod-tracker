...
drop table if exists public.mods cascade;
...
create index if not exists attires_owner_idx on public.attires (owner_id);
...
create policy "Public can read wrestlers"
on public.wrestlers
for select
using (true);

create policy "Authenticated can create wrestlers"
on public.wrestlers
for insert
to authenticated
with check (auth.uid() = owner_id);

create policy "Owners can update wrestlers"
on public.wrestlers
for update
to authenticated
...
create policy "Owners can delete wrestlers"
on public.wrestlers
for delete
to authenticated
using (auth.uid() = owner_id);
...
create policy "Public can read attires"
on public.attires
for select
using (true);

create policy "Authenticated can create attires"
on public.attires
for insert
to authenticated
with check (auth.uid() = owner_id);

create policy "Owners can update attires"
on public.attires
for update
to authenticated
using (auth.uid() = owner_id)
...
create policy "Owners can delete attires"
on public.attires
for delete
to authenticated
using (auth.uid() = owner_id);
...
on public.user_installed_attires
for select
to authenticated
...
create policy "Users can edit own requests"
on public.mod_requests
for update
to authenticated
using (auth.uid() = user_id)
...
create policy "Public can read mod assets"
on storage.objects
for select
using (bucket_id = 'mod-assets');

create policy "Users can upload own mod assets"
on storage.objects
for insert
to authenticated
with check (
...
create policy "Users can update own mod assets"
on storage.objects
for update
to authenticated
using (
...
create policy "Users can delete own mod assets"
on storage.objects
for delete
to authenticated
using (
